<?php 
	...
	try {
		if ($fecha_auto == "" || $tipo == "" || $fecha_pub == "" || $resenia == "" || $id_caso == "") {
			# code...
...
/*
			...
			$sql = "INSERT INTO expediente (fecha_auto, tipo_cuaderno, fecha_publicacion, resumen, id_caso) 
			VALUES ('$fecha_auto', '$tipo', '$fecha_pub', '$resenia', '$id_caso')";
			...
			if ($ok == FALSE) {
				...
				echo '<script language="javascript">window.location="subirsintesis.php?mensaje=1"</script>;';
			}
