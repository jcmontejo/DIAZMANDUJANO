<?php 
	...
	try {
		if ($resenia == "" || $status == "" || $clasificacion == "" || $tipo == "" || $matricula == "") {
			# code...
			...
			$sql = "INSERT INTO caso (resenia, status, clasificacion, tipo_caso, fecha_inicio, fecha_publicacion, fecha_auto, fecha_efectos, fecha_termino, conclusion, cliente_matricula) 
			VALUES ('$resenia', '$status', '$clasificacion', '$tipo', '$fecha_inicio', '$fecha_publicacion', '$fecha_auto', '$fecha_efectos', '$fecha_termino', '$conclusion', $matricula)";
