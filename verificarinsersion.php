...
include('includes/conexion.php');
		...
		try {
			...
			$comprobar = $base->query("SELECT * FROM cliente WHERE correo = '$email' AND catalogo_usuarios_usuario = '$usuario' ");
			...
			$sql = "INSERT INTO cliente (nombre,apellidos,correo,numero_telefono,direccion,catalogo_usuarios_usuario) 
			VALUES ('$nombre','$apellidos', '$email', '$numero','$direccion','$usuario')";
