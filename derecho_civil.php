            ...
            <ul class="nav navbar-right top-nav">
                 ...
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="vista_cliente.php"><i class="fa fa-fw fa-home"></i> Ajustes</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                                   ...
                                   <?php 
                                    ...
                                    while ($datos = $consulta2->fetch()) {
                                        # code...
                                            ...
                                            $consulta3 = $base->query("SELECT * FROM archivos WHERE id_caso = $id_caso AND derecho = 'Civil' ");
                                            $ok1 = $consulta3->fetch();
                                            $iden = $ok1['id_archivo'];
                                            echo "<tr>";
                                            ...
                                            echo "<td><a href=\"sintesis.php?id=$id_caso\"><button type=\"button\" class=\"btn btn-xs btn-info\">Ver</button></a></td>";
                                    }
